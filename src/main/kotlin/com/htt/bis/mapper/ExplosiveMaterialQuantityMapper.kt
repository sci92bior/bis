...
interface ExplosiveMaterialQuantityMapper {
    fun explosiveMaterialQuantityObjectToExplosiveMaterialQuantityDTO(explosiveMaterialQuantity: ExplosiveMaterialQuantity): ExplosiveMaterialQuantityDto
